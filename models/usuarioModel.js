...
class UsuarioModel {
  ...
  get usuario_documento() {
    return this.#usuario_documento;
  }
  set usuario_documento(documento) {
    this.#usuario_documento = documento;
  }

  get usuario_dataNasc() {
    return this.#usuario_dataNasc;
  }
  set usuario_dataNasc(data) {
    this.#usuario_dataNasc = data;
  }
  ...
  async obterPorEmailSenha(email, senha) {
    let sql =
      "select * from tb_usuario where usuario_email = ? and usuario_senha = ?";
    ...
    if (rows.length > 0) {
      ...
      return new UsuarioModel(
        ...
        row["usuario_status"],
        row["usuario_nome"],
        row["usuario_documento"],
        row["usuario_dataNasc"],
        row["usuario_email"],
        row["usuario_senha"]
      );
    }
