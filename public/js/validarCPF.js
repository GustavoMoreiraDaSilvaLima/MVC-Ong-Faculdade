class Validador {
  ...
  Validar_CPF_CNPJ() {
    ...
    if (this.#numberLocale.length == 11) {
      ...
      if (
        primeiroDigitoVerificador === 10 ||
        primeiroDigitoVerificador === 11
      ) {
        primeiroDigitoVerificador = 0;
      }
      if (
        primeiroDigitoVerificador !== parseInt(this.#numberLocale.charAt(9))
      ) {
        return false;
      }
      ...
      if (
        segundoDigitoVerificador !== parseInt(this.#numberLocale.charAt(10))
      ) {
        return false;
      }
      ...
      if (
        primeiroDigitoVerificador !== parseInt(this.#numberLocale.charAt(12))
      ) {
        return false;
      }
      // Calcula o segundo dígito verificador
      ...
      if (
        segundoDigitoVerificador !== parseInt(this.#numberLocale.charAt(13))
      ) {
        return false;
      }
